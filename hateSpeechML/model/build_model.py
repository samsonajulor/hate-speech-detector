...
# - uses hateSpeech to convert model to pure python code with zero dependencies
...
# - writes model to file `model.py` in the parent directory (hateSpeech/backend)
