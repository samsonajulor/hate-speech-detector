...
def classify(input): 
    """
    Predicts a given input's classification using the model generated with hateSpeech
    """
...
def format(input):
    """
    Transforms a given input so that it is in the format expected by the hateSpeech model
    """
    formatted_input = {}
...
def handle_advance(data):
    ...
    try:
        ...
        # converts input to the format expected by the hateSpeech model
